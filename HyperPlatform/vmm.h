...
/// Represents VMM related data shared across all processors 代表所有处理器共享的 VMM 相关数据
...
/// Represents VMM related data associated with each processor 代表与每个处理器相关的 VMM 相关数据
